...
sns.regplot(y=df_3['diabetes'], x=df_3['heart_disease'], ax=axs[1, 0])
sns.regplot(y=df_3['diabetes'], x=df_3['smoking_history'], ax=axs[1, 1])
sns.regplot(y=df_3['diabetes'], x=df_3['bmi'], ax=axs[1, 2])
sns.regplot(y=df_3['diabetes'], x=df_3['HbA1c_level'], ax=axs[2, 0])
sns.regplot(y=df_3['diabetes'], x=df_3['blood_glucose_level'], ax=axs[2, 1])
plt.tight_layout()
st.pyplot(fig5)
